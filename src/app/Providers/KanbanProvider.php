...
namespace Laurel\Kanban\App\Providers;

use Illuminate\Support\ServiceProvider;
use Laurel\Kanban\App\Http\Controllers\DeskController;
use Laurel\Kanban\App\Http\Controllers\CollumnController;
use Laurel\Kanban\App\Http\Controllers\CardController;
